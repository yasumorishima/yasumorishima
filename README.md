...
<!-- OSS_STATS_START -->(64 PRs / 32 Merged)<!-- OSS_STATS_END --> across 28 repositories. See [oss-contributions](https://github.com/yasumorishima/oss-contributions) for full details.
...
<!-- KAGGLE_DS_STATS_START -->10 published MLB datasets<!-- KAGGLE_DS_STATS_END -->
...
Full-stack web app for a high school baseball alumni association (<!--ob:ts_files-->135<!--/ob--> files, <!--ob:loc-->~15900<!--/ob--> LOC). **[Technical Documentation](https://github.com/yasumorishima/minami-baseball-ob-docs)**
...
5-tier RBAC (Middleware + RLS), automated member pipeline (Form → GAS → Actions → Supabase), <!--ob:senseki-->683<!--/ob--> match records (1955–present)
...
- **<!--ob:senseki-->683<!--/ob--> match records** (1955–present): cross-source verification, generation-based grouping, per-game photo management
